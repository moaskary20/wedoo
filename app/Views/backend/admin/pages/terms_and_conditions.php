...
<div class="main-content">
    <section class="section">
        <div class="section-header mt-2">
            <h1><?= labels('partner_terms_and_conditions', "Partner Terms and Conditions") ?></h1>
        ...
        <div class="">
            ...
            <ul class="nav nav-pills justify-content-center py-2 nav-fill" id="gen-list">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="<?= base_url('admin/settings/terms-and-conditions') ?>" id="pills-partner_terms_and_conditions" aria-selected="false">
        ...
        <form action="<?= base_url('admin/settings/terms-and-conditions') ?>" method="post">
            ...
            <div class="container-fluid card p-3">
                <div class="row">
                    <div class="col-lg">
                        <textarea rows=50 class='form-control h-50 summernotes' name="terms_conditions">
                            <?= isset($terms_conditions) ? $terms_conditions : 'Enter Terms & Conditions.' ?></textarea>
                    </div>
                </div>
                <div class="row mt-2">

                    <div class="col-md-6 mt-3 mb-4">
                        <a href="<?= base_url('admin/settings/provider_terms_and_condition'); ?>" class="btn btn-primary"><i class="fa fa-eye"></i> <?= labels('preview', 'Preview') ?></a>
                    </div>
