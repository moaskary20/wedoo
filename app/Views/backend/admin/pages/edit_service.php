                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="title" value="<?= isset($service['title']) ? $service['title'] : "" ?>" id="service_title">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="tags" style="border-radius: 0.25rem" class="w-100" type="text" name="tags[]" value="<?= isset($service['tags']) ? $service['tags'] : "" ?>" placeholder="<?= labels('press_enter_to_add_tag', 'press enter to add tag') ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-4 col-sm-4 col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="faqs[<?= $index ?>][]" type="text" placeholder="<?= labels('enter_question', 'Enter the question here') ?>" class="form-control" value="<?= $faq['question'] ?>" />
                                                    </div>
                                                </div>
                                                <div class="col-xs-7 col-sm-7 col-md-4">
                                                    <div class="form-group">
                                                        <label for="answer"><?= labels('answer', 'Answer') ?></label>
                                                        <input autocomplete="off" name="faqs[<?= $index ?>][]" type="text" placeholder="<?= labels('enter_answer', 'Enter the answer here') ?>" class="form-control" value="<?= $faq['answer'] ?>" />
                                                    </div>
                                                </div>
