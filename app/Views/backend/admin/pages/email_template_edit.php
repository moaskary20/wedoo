                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="subject" value="<?= $template['subject'] ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea rows="10" id="te" class="form-control h-50 summernotes custome_reset" name="template"> <?= $template['template'] ?></textarea>
                                </div>
                            </div>
                        </div>
