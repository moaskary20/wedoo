                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="type" id="type">
                                    ...
                                    <option value="new_booking_confirmation_to_customer" <?= ($template['type'] == "new_booking_confirmation_to_customer") ? 'selected' : '' ?>> <?= labels('new_booking_confirmation_to_customer', "Booking Confirmation for customer") ?> </option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="Enter title here" type="text" value="<?= $template['title'] ?>" name="title">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea id="template" rows="50" placeholder="<?= labels('enter_message_here', 'Enter Message Here') ?>" class="form-control " name="template"><?= $template['template'] ?></textarea>
                            </div>
                        </div>
                    </div>
