                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input id="bcc" style="border-radius: 0.25rem!important" class="w-100" type="text" name="bcc[]" placeholder="<?= labels('press_enter_to_add_bcc', 'Press enter to add BCC') ?>">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input id="cc" style="border-radius: 0.25rem" class="w-100" type="text" name="cc[]" placeholder="<?= labels('press_enter_to_add_cc', 'Press enter to add CC') ?>">
